...
const DEFS = {
  ...
  springIn: {
    ...
    name: 'バネ', tags: ['pop'], w: 0.9, minDur: 0.5,
  ...
  pendulum: {
    ...
    name: '振り子', tags: ['pop', 'emotional', 'calm'], w: 0.9, minDur: 0.5,
  ...
  rollIn: {
    ...
    name: '転がり', tags: ['pop', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  slingshot: {
    ...
    name: 'パチンコ', tags: ['pop', 'graphic'], w: 0.7, minDur: 0.55,
  ...
  rockSettle: {
    ...
    name: 'ぐらぐら着地', tags: ['pop'], w: 0.8, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.22, 0.9),
    apply(env, it, p) {
  ...
  bounceBall: {
    ...
    name: 'バウンドボール', tags: ['pop', 'emotional'], w: 0.8, minDur: 0.8, maxChars: 20,
  ...
  snapRail: {
    ...
    name: 'スナップ整列', tags: ['graphic', 'pop', 'editorial'], w: 0.9, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  fanOpen: {
    ...
    name: '扇開き', tags: ['emotional', 'graphic', 'calm'], w: 0.9,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  cylinder: {
    ...
    name: '円筒回転', tags: ['graphic', 'pop', 'editorial'], w: 0.9,
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  shuffle: {
    ...
    name: 'シャッフル', tags: ['pop', 'glitch', 'graphic'], w: 0.9, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, size = it.size, seed = it.seed | 0;
  ...
  stopMotion: {
    ...
    name: 'コマ撮り', tags: ['pop', 'emotional'], w: 0.8, minDur: 0.5,
  ...
  ripple: {
    ...
    name: '波紋', tags: ['emotional', 'calm', 'graphic'], w: 1,
    apply(env, it, p) {
  ...
  zoomAlt: {
    ...
    name: '交互ズーム', tags: ['pop', 'graphic', 'glitch'], w: 0.9,
    apply(env, it, p) {
  ...
  tiltUp: {
    ...
    name: '起立', tags: ['graphic', 'editorial', 'pop'], w: 0.9,
    apply(env, it, p) {
  ...
  stickerPeel: {
    ...
    name: 'シール貼り', tags: ['pop', 'graphic', 'editorial'], w: 0.9, minDur: 0.5,
  ...
  crumple: {
    ...
    name: 'くしゃ戻り', tags: ['pop', 'graphic', 'emotional'], w: 0.7, pieces: true, minDur: 0.5,
  ...
  noteUnfold: {
    ...
    name: '手紙開き', tags: ['emotional', 'calm', 'graphic'], w: 0.8, minDur: 0.6,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  tornJoin: {
    ...
    name: '破れ合わせ', tags: ['graphic', 'emotional', 'pop'], w: 0.8,
    inDur: dur => clamp(dur * 0.42, 0.18, 0.75),
    apply(env, it, p) {
  ...
  splitFlap: {
    ...
    name: 'パタパタ', tags: ['glitch', 'editorial', 'graphic'], w: 0.9, minDur: 0.75,
  ...
  overexpose: {
    ...
    name: '露出オーバー', tags: ['emotional', 'pop', 'glitch'], w: 1,
    inDur: dur => clamp(dur * 0.42, 0.18, 0.75),
    apply(env, it, p) {
  ...
  glint: {
    ...
    name: 'グリント', tags: ['editorial', 'emotional', 'graphic'], w: 1,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  loupe: {
    ...
    name: 'ルーペ', tags: ['editorial', 'pop', 'calm'], w: 0.8, minDur: 0.6,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  filmFeed: {
    ...
    name: 'フィルム送り', tags: ['emotional', 'glitch', 'editorial'], w: 0.8, minDur: 0.55,
  ...
  backlight: {
    ...
    name: '逆光', tags: ['emotional', 'calm'], w: 0.9, minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
  ...
  lightLeak: {
    ...
    name: '光漏れ', tags: ['emotional', 'calm', 'pop'], w: 0.9,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  heatHaze: {
    ...
    name: '陽炎', tags: ['emotional', 'calm', 'glitch'], w: 0.9,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  crtOn: {
    ...
    name: 'CRT電源', tags: ['glitch', 'pop', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  interlace: {
    ...
    name: 'インターレース', tags: ['glitch', 'graphic', 'editorial'], w: 0.9,
    apply(env, it, p) {
  ...
  loadingBar: {
    ...
    name: 'ローディング', tags: ['graphic', 'editorial', 'glitch'], w: 0.8, minDur: 0.7,
  ...
  dither: {
    ...
    name: 'ディザ', tags: ['glitch', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  odometer: {
    ...
    name: 'ドラム回転', tags: ['glitch', 'editorial', 'pop'], w: 0.9, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  matrixRain: {
    ...
    name: 'データ降下', tags: ['glitch', 'graphic'], w: 0.8, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  hatchFill: {
    ...
    name: 'ハッチ→ベタ', tags: ['graphic', 'editorial'], w: 0.9,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  brushReveal: {
    ...
    name: '筆払い', tags: ['emotional', 'editorial', 'calm'], w: 1,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.85),
    apply(env, it, p) {
  ...
  inkDrop: {
    ...
    name: 'インク滴', tags: ['calm', 'emotional', 'graphic'], w: 1,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.85),
    apply(env, it, p) {
  ...
  quarters: {
    ...
    name: '四方集結', tags: ['graphic', 'pop'], w: 0.9,
    apply(env, it, p) {
  ...
  invertBox: {
    ...
    name: '反転抜け', tags: ['graphic', 'editorial', 'pop'], w: 0.9,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  printRegister: {
    ...
    name: '版ズレ', tags: ['graphic', 'pop', 'editorial'], w: 0.9,
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  echoCount: {
    ...
    name: 'カウントイン', tags: ['pop', 'graphic', 'glitch'], w: 0.8, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  liquidFill: {
    ...
    name: '水位上昇', tags: ['emotional', 'calm', 'pop'], w: 0.9, minDur: 0.5,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  windBlown: {
    ...
    name: '風に乗って', tags: ['emotional', 'calm'], w: 0.8, pieces: true, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      if (p >= 1) return;
  ...
  strokeOrder: {
    ...
    name: '一画ずつ', tags: ['calm', 'emotional', 'editorial'], w: 0.9, pieces: true, minDur: 0.6,
  ...
  clockWipe: {
    ...
    name: '時計回り', tags: ['graphic', 'pop', 'editorial'], w: 0.9,
    apply(env, it, p) {
      const isx = it.sx || 1, isy = it.sy || 1, size = it.size, seed = it.seed | 0;
      const qf = (i, n) => stg(p, ordLR(i, n), 0.5);
  ...
  shadowFirst: {
    ...
    name: '影落とし', tags: ['pop', 'graphic', 'emotional'], w: 0.9, minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
  ...
  bubbles: {
    ...
    name: '泡', tags: ['pop', 'emotional', 'calm'], w: 0.8, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  tokoroten: {
    ...
    name: 'ところてん', tags: ['pop', 'graphic'], w: 0.7, minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
